"""
Django base settings for Heartbeat project.
"""
import os
...
# Database
# Always use Aiven PostgreSQL (both development and production)
DATABASES = {
    'default': {
        ...
        'HOST': config('DB_HOST'),
        'PORT': config('DB_PORT', default='21699'),
        'OPTIONS': {
            'sslmode': 'require',
            'connect_timeout': 10,
        },
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',     # Primary for React
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='heartbeat@localhost')

# Use custom User model (for future extensibility)
