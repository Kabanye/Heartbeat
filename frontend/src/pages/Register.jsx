...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#170E1F] relative overflow-hidden px-4 py-10">
      {/* Ambient glow */}
      <div
        ...
        <div className="rounded-[28px] border border-white/[0.06] bg-[#1F1329]/80 backdrop-blur-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.65)] overflow-hidden">
          ...
          <div className="px-8 pt-7 pb-9">
              ...
              >
                ...
                {status === 'loading' && (
                  <span className="absolute inset-0 flex items-center justify-center">
                    ...
                    <span className="ml-2 text-[#1B0E12] text-sm">Creating account</span>
                  </span>
                )}
            ...
            <p className="text-center text-[13px] text-[#9C8AA0] mt-6">
              ...
              <Link to="/login" className="text-[#FF8FA3] hover:text-[#FFB4A8] transition-colors font-medium">
                Login
              </Link>
            </p>
          </div>
